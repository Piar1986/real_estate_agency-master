...
class Flat(models.Model):
    owner = models.ManyToManyField('Owner', verbose_name="Владельцы квартиры", related_name="owner_flats", max_length=200)
...
class Complaint(models.Model):
    author = models.ForeignKey(User, verbose_name="Кто жаловался", related_name="complaints", on_delete=models.CASCADE)
    flat = models.ForeignKey(Flat, verbose_name="Квартира, на которую пожаловались", related_name="complaints", 
...
class Owner(models.Model):
    ...
    flat = models.ManyToManyField(Flat, verbose_name="Квартиры в собственности", related_name="flat_owners", blank=True, db_index=True)
